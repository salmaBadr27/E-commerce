		...
		<div class="container col-sm-12">
			...
			<div class="table-responsive cart_info">
				...
				<table class="table table-condensed">
					...
					<tbody>
					<!-- loop through content of card each row consist of {image ,name,price,qty,}-->
						<?php foreach ($contents as $contents) {?>
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{URL::to($contents->options->image)}}" height="80px" width="80px" alt=""></a>
							</td>
							...
							<!-- update quantity of product to purchase it-->
							...
							<td class="cart_delete">
								...
								<a class="cart_quantity_delete" href="{{URL::to('/delete-to-cart/'.$contents->rowId)}}"><i class="fa fa-times"></i></a>
							</td>
						</tr>
                       <?php }?>
				...
				<div class="col-sm-8">
					<div class="total_area">
						<ul>
							...
							<!--if customer logged in then redirect to Checkout else redirect to login form-->
