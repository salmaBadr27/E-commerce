...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body{ background-image: url('{{URL::to("backend/img/bg-login.jpg")}}'); !important; }
		</style>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<!--flash message will show to user if he is trying to access to admin panel
					without login will receive session message if records dosent match input field
					 if message not empty then update it to null ??-->
