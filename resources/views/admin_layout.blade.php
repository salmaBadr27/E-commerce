...
<body>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								...
								{{Session::get('admin_name')}} <!-- get user name of logged user -->
	...
	<!-- <footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2013 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes"></a></span>
		</p>
